							...
							<tr>
				          	...
				          	foreach($getAll as $rw)
								...
								<td class="pmd-table-row-action">
									...
									<a href="index.php?mod=baigui&ac=send&id=<?php echo $r["id_baiviet"];?>" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm pmd-tooltip" data-toggle="tooltip" data-placement="top" title="Gửi bài và chờ được duyệt">
