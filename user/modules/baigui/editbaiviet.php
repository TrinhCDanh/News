    ...
    ?>
      <div class="col-md-12">
        <div class="alert alert-warning">      
          <?php echo "Yêu cầu sửa từ Admin: " . $row["yeucau_baiviet"]; ?>
        </div>
      </div>
    <?php
  }
?>
<form id="validationForm" action="index.php?mod=baigui&ac=saveEdit&id=<?php echo $row["id_baiviet"]; ?>" method="post"  enctype="multipart/form-data">
  <div class="col-md-9">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="form-group pmd-textfield">       
                ...
                <select class="select-simple form-control pmd-select2" name="trangthai_baiviet">
                  <option value="1" selected>Chờ duyệt bài</option>
                </select>
              </div>
              <div class="form-group pmd-textfield">
